---
name: kennedy-go
description: "Invoke with /kennedy-go. Apply modern Go syntax guidelines based on the project's Go version. Use whenever writing, editing, or reviewing Go (.go) code — not only when explicitly asked for guidelines."
user_invocable: true
version: "1.0.0"
---
